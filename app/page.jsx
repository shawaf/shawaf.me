    ...
    <section className="h-full">
      <div className="container mx-auto h-full pb-16">
        <div className="relative overflow-hidden rounded-3xl border border-border/60 bg-card/70 px-6 py-12 shadow-xl shadow-accent/10 backdrop-blur-xl xl:px-12">
          ...
          <div className="relative grid gap-12 lg:grid-cols-2 lg:items-start lg:gap-14">
            {/* Intro */}
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Social
                  ...
                  iconStyles="h-10 w-10 rounded-full border border-border/80 bg-background/60 text-lg text-foreground shadow-sm transition hover:-translate-y-0.5 hover:border-accent hover:text-accent"
                />
              </div>
            ...
            <div className="space-y-6">
              <div className="relative overflow-hidden rounded-2xl border border-border/70 bg-gradient-to-br from-background via-background/40 to-muted/60 p-6 shadow-lg shadow-accent/20">
                <div className="grid gap-8 items-center sm:grid-cols-[auto,1fr]">
              ...
              <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                {highlights.map((item) => (
                  <div
                    key={item.title}
                    className="group relative overflow-hidden rounded-2xl border border-border/70 bg-card/60 p-5 shadow-md transition hover:-translate-y-1 hover:border-accent/60 hover:shadow-accent/20"
                  >
